...
public class MessageHandlingAppTest implements Serializable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        app.init(args);
        //测试，只有一个目录
        app.generatePresetCommand("/user/vpetest.cripac/source_data/testvideo", "source_data");
      
//        String[] fileStrings=app.getFileList("/user/vpetest.cripac/source_data/video/");
...
//        app.generatePresetCommand("/user/vpe.cripac/test/da.li/videos/2014-02-26", "test");
    ...
    private String[] getFileList(String path) throws Exception {
        ...
        List<String> filesAllList = new ArrayList<String>();
...
//            }
        ...
        return filesAllList.toArray(new String[]{});
    }
    /**
     * 递归打印目录下所有文件和文件夹
     * LANG
     ...
     * @throws Exception
     */
    public void traverseFolder1(Path path,FileSystem hdfs,List<String> filesAllList) throws Exception{
		...
		if (hdfs.exists(path)) {
			...
			FileStatus[] fs =hdfs.listStatus(path);
				...
				if (hdfs.isDirectory(paths[i])) {
					...
					filesAllList.add(paths[i].toString());
					eachFileNum++;
				}
			}
		}
    ...
    public void generatePresetCommand(String path, String flag) throws Exception {
        ...
        for (String filename : filenames) {
            ...
            sendWithLog(DataType.COMMAND.name(),
                    MessageHandlingApp.CommandType.FASTER_ONLY,
                    serialize(param),
                    producer,
                    logger);*/
    ...
    public void generatePresetCommand() throws Exception {
        String[] cam01VideoURLs = {
                "source_data/video/CAM01/2014-02-26/CAM01-20140226110113-20140226110701.h264",
