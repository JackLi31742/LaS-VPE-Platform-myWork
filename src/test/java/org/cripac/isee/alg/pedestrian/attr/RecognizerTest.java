...
//                break;
            /*case DeepMARCaffe2Native:
                recognizer = new DeepMARCaffe2Native(
                        propCenter.caffeGPU,
                        new File("models/DeepMARCaffe2/init_net.pb"),
                        new File("models/DeepMARCaffe2/predict_net.pb"),
                        logger);
                break;*/
            case Fake:
    ...
    public void setUp() throws ParserConfigurationException, IOException, SAXException, URISyntaxException {
        ...
        propCenter = new PedestrianAttrRecogApp.AppPropertyCenter(new String[]{
                "-a", PedestrianAttrRecogApp.APP_NAME,
