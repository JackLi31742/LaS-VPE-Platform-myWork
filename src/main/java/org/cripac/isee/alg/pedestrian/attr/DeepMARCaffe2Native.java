 ...
 */
public class DeepMARCaffe2Native implements DeepMARCaffe2, BatchRecognizer,Serializable {
    /**
	 * 
	 */
    ...
    static {
        org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(DeepMARCaffe2Native.class);
        try {
     ...
     */
    public synchronized native void free(long p);
...
//                DeepMAR.randomlyPickGPU(gpu),
        ...
        this.logger.debug("DeepMARCaffe2Native initialized!,net的值是："+net+",使用的gpu是:"+gpu+"耗时："+(end-start)/1000+"s");
    }
