...
public class DeepMARCaffe2NativeFactory extends BaseKeyedPoolableObjectFactory<String, DeepMARCaffe2Native> implements Serializable{
...
//		this.logger=loggerSingleton.getInst();
	...
	public DeepMARCaffe2NativeFactory(Singleton<Logger> loggerSingleton) {
	super();
	this.loggerSingleton = loggerSingleton;
}
	...
	public DeepMARCaffe2Native makeObject(String gpu) throws Exception {
		...
		DeepMARCaffe2Native deepMARCaffe2Native=new DeepMARCaffe2Native(gpu,loggerSingleton.getInst());
